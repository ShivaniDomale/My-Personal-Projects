...
document.getElementById("loginForm").addEventListener("submit", async function (event) {
    ...
    if (passwordInput.length < 4) {
        alertMessage.innerText = "Password must be at least 4 characters long.";
        alertMessage.style.display = "block";
        return;
    }

    // Simulate form submission (use actual endpoint in production)
    try {
        ...
        if (response.ok) {
            ...
            alertMessage.innerText = result.message || "Login failed. Try again.";
            alertMessage.style.display = "block";
        }
    } catch (error) {
